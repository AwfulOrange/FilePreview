	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (FileItem item : items) {
				if (!item.isFormField()) {
//					String name = item.getName().substring(1, item.getName().length());
//					String filePath = "//Users//appleone//Documents//orginFile//" + item.getName();
//					File file = new File("//Users//appleone//Documents//orginFile//", item.getName());//mac path
					String filePath="C:\\Users\\amber.chen\\data\\"+item.getName();
					
					File file = new File("C:\\Users\\amber.chen\\data"+"", item.getName());//windows path
					item.write(file);
					...
					fp.setPreviewcount(0);
					fp.setFilemd5("default_md5");
					fp.setLastpreviewtime(null);
					fp.setPreviewfilepath(null);
					fp.setUploaduserid("1");
