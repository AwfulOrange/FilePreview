...
<title>Login form :: Metro UI CSS - The front-end framework for
...
.bg {
	background-image: url("images/bgKite1.JPG");
...
<body class="bg">
	<div class="login-form padding20 block-shadow">
		<form action="LoginServlet" method=post>
			<h1 class="text-light">FilePreview</h1>
			<hr class="thin" />
			<br />
			<div class="input-control text full-size" data-role="input">
				<label for="user_login">User ID:</label> <input type="text"
			...
			<div class="input-control password full-size" data-role="input">
				<label for="user_password">User password:</label> <input
	...
	<!-- hit.ua -->
	<a href='http://hit.ua/?x=136046' target='_blank'> <script
